...
def file_name(a):
    ...
    with open (a,'r') as f:
        for line in f:
            ...
            stock='893520191030%s%s,%s,%s,%s,%s,%s,,,,'%(line_ic,rand_val,line_imsi,random.randint(1000,9999),random.randint(10000000,99999999),random.randint(10000000,99999999),sim_type)
            actual='893520191030%s%s,%s'%(line_ic,rand_val,line_imsi)
